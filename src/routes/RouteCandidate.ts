...
const controllerCandidate = new CandidateController(GetAllCandidateService,GetOneCandidateService,StoreCandidateService,DeleteCandidateService, candidateSaveProfessionalResume);
